...
<!--
  ...
  phrase in the table below across the kit (case-insensitive, literal match)
  and fails the build if one appears anywhere outside this file and the
  CHANGELOG. Superseded copy goes on this list the day it is replaced.

  Rules for entries:
  - The Phrase column must be a literal string (no regex, no placeholders) —
...
<!--
  Delete the example row before first use — CI treats every row as live.

| Phrase | Use instead | Ruling |
|---|---|---|
| [e.g. "industry average tenure under three years"] | [e.g. "the approved tenure claim in reference/evidence.md"] | [e.g. "Not supportable — corrected DD Mon YYYY, see evidence register"] |
-->
